...
ttSemiLepInc = Sample.fromDirectory( "ttSemiLepInc", [os.path.join(directory, subdir) for subdir in ["TTToSemiLeptonic_UL16", "TTToSemiLeptonic_UL17"]]) 
...
for var, name, texX in [ 
    ...
    h_inclusive = ttSemiLepInc.get1DHistoFromDraw( var, [20,-1,1] )
    ...
    eff_inclusive = ttSemiLepInc.get1DHistoFromDraw( var, [20,-1,1], selectionString = selectionString)
    eff_inclusive.style = styles.lineStyle( ROOT.kBlue, errors=True)
    eff_inclusive.Sumw2(0)
