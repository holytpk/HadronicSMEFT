...
read_variables = [\
    ...
    "parton_lepTop1_pt/F", "parton_lepTop1_eta/F", "parton_lepTop1_phi/F", "parton_lepTop1_mass/F", 
    "parton_lepTop1_W_pt/F", "parton_lepTop1_W_eta/F", "parton_lepTop1_W_phi/F", "parton_lepTop1_W_mass/F", 
    "parton_lepTop1_lep_pt/F", "parton_lepTop1_lep_eta/F", "parton_lepTop1_lep_phi/F", "parton_lepTop1_lep_mass/F", 
    "parton_lepTop1_nu_pt/F", "parton_lepTop1_nu_eta/F", "parton_lepTop1_nu_phi/F", "parton_lepTop1_nu_mass/F", 
    "parton_lepTop1_b_pt/F", "parton_lepTop1_b_eta/F", "parton_lepTop1_b_phi/F", "parton_lepTop1_b_mass/F",

    "parton_lepTop2_pt/F", "parton_lepTop2_eta/F", "parton_lepTop2_phi/F", "parton_lepTop2_mass/F",
    "parton_lepTop2_W_pt/F", "parton_lepTop2_W_eta/F", "parton_lepTop2_W_phi/F", "parton_lepTop2_W_mass/F",
    "parton_lepTop2_lep_pt/F", "parton_lepTop2_lep_eta/F", "parton_lepTop2_lep_phi/F", "parton_lepTop2_lep_mass/F",
    "parton_lepTop2_nu_pt/F", "parton_lepTop2_nu_eta/F", "parton_lepTop2_nu_phi/F", "parton_lepTop2_nu_mass/F",
    "parton_lepTop2_b_pt/F", "parton_lepTop2_b_eta/F", "parton_lepTop2_b_phi/F", "parton_lepTop2_b_mass/F",

    #"delphesJet_dR_lepTop1_q1/F", " delphesJet_dR_lepTop1_q2/F", "delphesJet_dR_lepTop1_W/F", "delphesJet_dR_lepTop1_b/F", 
    #"delphesJet_dR_matched_lepTop1_parton/F", "delphesJet_dR_lepTop1_maxq1q2b/F", 

    "parton_lepTop1_decayAngle_phi/F", "parton_lepTop1_decayAngle_phi/F",
...
plots.append(Plot( name = "parton_lepTop1_pt",
  texX = "parton p_{T}(t)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop1_eta",
  texX = "parton #eta(t)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop1_phi",
  texX = "parton #phi(t)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop1_mass",
  texX = "parton M(t)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_mass,
  binning   =  [50,150,200],
))

plots.append(Plot( name = "parton_lepTop1_mass_largescale",
  texX = "parton M(t)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_mass,
  binning   =  [100,0,250],
))

plots.append(Plot( name = "parton_lepTop1_W_pt",
  texX = "p_{T}(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_W_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop1_W_eta",
  texX = "#eta(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_W_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop1_W_phi",
  texX = "#phi(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_W_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop1_W_mass",
  texX = "M(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_W_mass,
  binning   =  [50,50,100],
))

plots.append(Plot( name = "parton_lepTop1_W_mass_largescale",
  texX = "M(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_W_mass,
  binning   =  [100,0,150],
))

plots.append(Plot( name = "parton_lepTop1_lep_pt",
  texX = "p_{T}(l^{+})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_lep_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop1_lep_eta",
  texX = "#eta(l^{+})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_lep_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop1_lep_phi",
  texX = "#phi(l^{+})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_lep_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop1_lep_mass",
  texX = "M(l^{+})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_lep_mass,
  binning   =  [50,0,20],
))

plots.append(Plot( name = "parton_lepTop1_nu_pt",
  texX = "p_{T}(#nu)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_nu_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop1_nu_eta",
  texX = "#eta(#nu)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_nu_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop1_nu_phi",
  texX = "#phi(#nu)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_nu_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop1_nu_mass",
  texX = "M(#nu)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_nu_mass,
  binning   =  [50,0,20],
))

plots.append(Plot( name = "parton_lepTop1_b_pt",
  texX = "p_{T}(b)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_b_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop1_b_eta",
  texX = "#eta(b)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_b_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop1_b_phi",
  texX = "#phi(b)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_b_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop1_b_mass",
  texX = "M(b)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_b_mass,
  binning   =  [50,0,10],
))


plots.append(Plot( name = "parton_lepTop2_pt",
  texX = "parton p_{T}(#bar{t})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop2_eta",
  texX = "parton #eta(#bar{t})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop2_phi",
  texX = "parton #phi(#bar{t})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop2_mass",
  texX = "parton M(#bar{t})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_mass,
  binning   =  [50,150,200],
))

plots.append(Plot( name = "parton_lepTop2_mass_largescale",
  texX = "parton M(#bar{t})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_mass,
  binning   =  [100,0,250],
))

plots.append(Plot( name = "parton_lepTop2_W_pt",
  texX = "p_{T}(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_W_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop2_W_eta",
  texX = "#eta(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_W_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop2_W_phi",
  texX = "#phi(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_W_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop2_W_mass",
  texX = "M(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_W_mass,
  binning   =  [50,50,100],
))

plots.append(Plot( name = "parton_lepTop2_W_mass_largescale",
  texX = "M(W)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_W_mass,
  binning   =  [100,0,150],
))

plots.append(Plot( name = "parton_lepTop2_lep_pt",
  texX = "p_{T}(l^{-})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_lep_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop2_lep_eta",
  texX = "#eta(l^{-})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_lep_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop2_lep_phi",
  texX = "#phi(l^{-})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_lep_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop2_lep_mass",
  texX = "M(l^{-})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_lep_mass,
  binning   =  [50,0,20],
))

plots.append(Plot( name = "parton_lepTop2_nu_pt",
  texX = "p_{T}(#bar{#nu})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_nu_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop2_nu_eta",
  texX = "#eta(#bar{#nu})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_nu_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop2_nu_phi",
  texX = "#phi(#bar{#nu})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_nu_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop2_nu_mass",
  texX = "M(#bar{#nu})", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_nu_mass,
  binning   =  [50,0,20],
))

plots.append(Plot( name = "parton_lepTop2_b_pt",
  texX = "p_{T}(b)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_b_pt,
  binning   =  [20,0,1000],
))

plots.append(Plot( name = "parton_lepTop2_b_eta",
  texX = "#eta(b)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_b_eta,
  binning   =  [20,-4,4],
))

plots.append(Plot( name = "parton_lepTop2_b_phi",
  texX = "#phi(b)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_b_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop2_b_mass",
  texX = "M(b)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop2_b_mass,
  binning   =  [50,0,10],
))
...
plots.append(Plot( name = "parton_lepTop1_decayAngle_phi",
  texX = "#phi (gen decay)", texY = 'Number of Events',
  attribute = lambda event, sample: event.parton_lepTop1_decayAngle_phi,
  binning   =  [20,-pi,pi],
))

plots.append(Plot( name = "parton_lepTop1_decayAngle_theta",
